...
local Rocket = require("game/rocket/rocket_start/rocket")
local RocketActor = require("game/rocket/rocket_start/rocketActor")
...
rocketGame.new = function()
  ...
  local onBegin = function()
    ...
    rocketGame.world = love.physics.newWorld(0, 9.81 * 64, true) --create a world for the bodies to exist in with horizontal gravity of 0 and vertical gravity of 9.81
    ...
    actors[#actors + 1] = addBlock({x = 400, y = 100}, 45)
 
    actors[#actors + 1] = RocketActor.new({ position = { x = 200, y = 500 }, gfx = Rocket.gfx.normal })
    actors[#actors + 1] = RocketActor.new({ position = { x = 300, y = 500 }, gfx = Rocket.gfx.happy })
    actors[#actors + 1] = RocketActor.new({ position = { x = 400, y = 500 }, gfx = Rocket.gfx.scared })
    actors[#actors + 1] = RocketActor.new({ position = { x = 500, y = 500 }, gfx = Rocket.gfx.thinking })
  end
